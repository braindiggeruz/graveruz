  ...
  ru: [
    {
      ...
      contentHtml: `<h2 id="why-gifts-for-employees">Почему подарки сотрудницам на 8 марта?</h2>
<p>Подарок на 8 марта сотрудницам — это способ показать благодарность за их работу, внимание и преданность компании. Это укрепляет командный дух и повышает мотивацию.</p>

<h2 id="gift-ideas-15">15 лучших идей подарков на 8 марта</h2>
<ul><li><strong>Часы с гравировкой</strong> — элегантный и практичный подарок, который будет напоминать о компании каждый день</li><li><strong>Украшение с инициалами</strong> — браслет или кулон с персональной гравировкой</li><li><strong>Ручка премиум-класса</strong> — красивая и функциональная вещь для работы</li><li><strong>Powerbank с логотипом</strong> — полезный гаджет для современной женщины</li><li><strong>Ежедневник кожаный</strong> — практичный подарок для организации</li><li><strong>Кружка с фотографией</strong> — сентиментальный подарок с памятным моментом</li><li><strong>Зажигалка Zippo</strong> — стильный подарок для коллеги</li><li><strong>Фото-кубик</strong> — уникальный подарок с командными фотографиями</li><li><strong>Парфюм премиум-класса</strong> — люксовый подарок</li><li><strong>Кошелёк из натуральной кожи</strong> — практичный и красивый подарок</li><li><strong>Блокнот с логотипом компании</strong> — полезный подарок для работы</li><li><strong>Украшение для рабочего стола</strong> — красивый декор для офиса</li><li><strong>Свеча ароматическая</strong> — расслабляющий подарок</li><li><strong>Сумка или рюкзак</strong> — практичный подарок для повседневного использования</li><li><strong>Набор косметики</strong> — люксовый подарок для ухода за собой</li></ul>

<h2 id="budget-options-employees">Варианты по бюджету</h2>
<ul><li><strong>До 50 000 сум:</strong> ручки, кружки, блокноты, свечи</li><li><strong>50-150 000 сум:</strong> часы, украшения, powerbank, парфюм</li><li><strong>150-500 000 сум:</strong> люксовые часы, украшения, кошельки из кожи</li></ul>

<h2 id="personalization-importance">Персонализация — ключ к успеху</h2>
<p>Добавьте гравировку с именем сотрудницы, датой или специальным сообщением. Это сделает подарок по-настоящему особенным и покажет, что вы думали о каждой сотрудницы индивидуально.</p>

<h2 id="presentation-and-delivery">Оформление и доставка</h2>
<p>Мы предлагаем:</p>
<ul><li>Красивую упаковку в подарочную коробку</li><li>Быструю доставку по Ташкенту</li><li>Профессиональную гравировку</li><li>Консультацию по выбору подарков</li></ul>

<h2 id="how-to-order-employees">Как заказать подарки?</h2>
<ol><li>Напишите нам в Telegram с количеством сотрудниц и бюджетом</li><li>Выберите вариант подарков из каталога</li><li>Мы подготовим макеты для гравировки</li><li>Вы утверждаете макеты</li><li>Мы выполняем заказ и доставляем в офис</li></ol>

<h2 id="why-choose-us">Почему выбрать нас?</h2>
<ul><li>Более 5 лет опыта в гравировке и подарках</li><li>Качественные материалы и исполнение</li><li>Персональный подход к каждому заказу</li><li>Быстрые сроки выполнения</li><li>Гарантия качества</li></ul>

<p><strong>Свяжитесь с нами в Telegram прямо сейчас для консультации и получите скидку на первый заказ!</strong></p>`
    },
    {
